...
const Toast = ({ children, id, type, style }) => {
  ...
  `} style={style}>
    ...
    <div className='react-notie-dismiss' onClick={() => removeToast(id)}><CrossIcon/></div>
  </div>
}
...
const transitions = useTransition(toasts, toast => toast.id, {
  ...
  return <div className='fixed flex flex-col justify-end left-6 z-10 top-0 bottom-0 h-full'>
